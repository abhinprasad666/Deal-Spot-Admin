...
const ProductTableRow = ({ product, onEdit, onDelete }) => {
  return (
    <tr className="hover:bg-gray-50 dark:hover:bg-gray-800 transition">
      ...
      <td className="px-4 py-3 font-medium text-gray-800 dark:text-gray-100 truncate max-w-[200px]" title={product.title}>
        {product.title}
      </td>
      ...
      <td className="px-4 py-3 flex justify-center space-x-2">
        ...
        <button onClick={() => onDelete(product._id)} className="text-red-600 hover:text-red-800" title="Delete">
          <Trash2 size={18} />
        </button>
      </td>
    </tr>
