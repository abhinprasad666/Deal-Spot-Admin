...
const CategoryTableRow = ({ category, isEditing, onEditStatus, onUpdateStatus, onCancelEdit }) => (
    <tr key={category._id} className="h-14">
        ...
        <td className="px-4 py-2 text-center">
            <div className="flex justify-center gap-3">
                <Link to={`/admin/edit/category/${category._id}`} className="text-blue-600 hover:text-blue-800">
